...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 11, 2020 at 07:11 AM
...
INSERT INTO `admission` (`ad_no`, `NIC`, `ward_no`, `bed_no`, `status`) VALUES
(4000, '123456789v', 4, 2, 'admitted'),
(4001, '111011111v', 2, 7, 'admitted');
...
(1, '2019-12-19', '11:14:19', 1001, 1, '123456789v'),
(2, '2019-12-27', '11:48:26', 1001, 1, '987654321v'),
(3, '2020-04-04', '00:00:05', 1000, NULL, '678678678v'),
(4, '2020-06-07', '00:00:05', 1001, NULL, '232323232v');
...
(1002, 'ram prasad', NULL),
(1003, 'tom gunawardana', 2500);
...
INSERT INTO `patient` (`NIC`, `name`, `age`, `tel_no`) VALUES
('123456789v', 'supun fernando', 21, 0),
('987654321v', 'paul george', 16, 0),
('102345678v', 'donald kumar', 42, 0),
('2356788v', 'ram', 23, 111111111),
('777777777v', 'prem kumar', 43, 0),
('678678678v', 'kumara fernando', 76, 1234567899),
('111111111v', 'tharindu', 25, 0),
('111011111v', 'tharindu', 25, 0);
...
INSERT INTO `ward` (`ward_no`, `d_id`) VALUES
(4, 1003);
COMMIT;
