...
INSERT INTO `appointment` (`a_id`, `Name`, `NIC`, `Contact`, `date`, `time`, `d_id`, `c_id`) VALUES
(1, 'Nathan De Lima', '32333', '0770541166', '2019-09-23', '0000-00-00 00:00:00', NULL, NULL),
(2, 'Jamal Baloch', '43434', '0526317764', '2019-06-11', '0000-00-00 00:00:00', NULL, NULL);
...
CREATE TABLE `front office clerk` (
...
--
-- Indexes for table `front office clerk`
--
ALTER TABLE `front office clerk`
